  ...
  template: `
    <div class="dash-page">
      <div class="dash-header">
        ...
        <p>Bienvenue, {{ auth.user()?.prenom }}. Gérez vos services et réservations.</p>
      </div>
      <div class="dash-grid">
        <a routerLink="/prestataire/profil" class="dash-card">
        ...
        <a routerLink="/prestataire/services" class="dash-card">
          <div class="dash-icon" style="background:linear-gradient(135deg,#6a1b9a,#ab47bc)"><mat-icon>build</mat-icon></div>
          <h3>Mes services</h3>
          <p>Gérer mes offres</p>
          <mat-icon class="dash-arrow">arrow_forward</mat-icon>
        </a>
        <a routerLink="/prestataire/disponibilites" class="dash-card">
          <div class="dash-icon" style="background:linear-gradient(135deg,#00838f,#26c6da)"><mat-icon>schedule</mat-icon></div>
          <h3>Disponibilités</h3>
          <p>Gérer mes créneaux</p>
          <mat-icon class="dash-arrow">arrow_forward</mat-icon>
        </a>
        <a routerLink="/prestataire/reservations" class="dash-card">
