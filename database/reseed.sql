...
DBCC CHECKIDENT ('villes', RESEED, 0);
DBCC CHECKIDENT ('categories', RESEED, 0);
DBCC CHECKIDENT ('sous_categories', RESEED, 0);
DBCC CHECKIDENT ('users', RESEED, 0);
DBCC CHECKIDENT ('clients', RESEED, 0);
DBCC CHECKIDENT ('prestataires', RESEED, 0);
DBCC CHECKIDENT ('admins', RESEED, 0);
DBCC CHECKIDENT ('services', RESEED, 0);
DBCC CHECKIDENT ('disponibilites', RESEED, 0);
DBCC CHECKIDENT ('commentaires', RESEED, 0);
GO
...
INSERT INTO dbo.users(nom,prenom,email,mot_de_passe,role) VALUES
 (N'Admin',N'Super',N'admin@plateforme.fr',N'$2b$10$8hziSmZxIDIMx8/Ef0Z8d.G7i6rQE4Fj6sIfH1NIeskSSTrf/SeQy',N'ADMIN');
INSERT INTO dbo.admins(id_user) VALUES (SCOPE_IDENTITY());

-- Comptes clients
INSERT INTO dbo.users(nom,prenom,email,mot_de_passe,role) VALUES
 (N'Dupont',N'Marie',N'marie.dupont@example.fr',N'$2b$10$8hziSmZxIDIMx8/Ef0Z8d.G7i6rQE4Fj6sIfH1NIeskSSTrf/SeQy',N'CLIENT');
INSERT INTO dbo.clients(id_user) VALUES (SCOPE_IDENTITY());

INSERT INTO dbo.users(nom,prenom,email,mot_de_passe,role) VALUES
 (N'Martin',N'Lucas',N'lucas.martin@example.fr',N'$2b$10$8hziSmZxIDIMx8/Ef0Z8d.G7i6rQE4Fj6sIfH1NIeskSSTrf/SeQy',N'CLIENT');
INSERT INTO dbo.clients(id_user) VALUES (SCOPE_IDENTITY());

-- Comptes prestataires
INSERT INTO dbo.users(nom,prenom,email,mot_de_passe,role) VALUES
 (N'Bernard',N'Pierre',N'pierre.plombier@example.fr',N'$2b$10$8hziSmZxIDIMx8/Ef0Z8d.G7i6rQE4Fj6sIfH1NIeskSSTrf/SeQy',N'PRESTATAIRE');
...
INSERT INTO dbo.users(nom,prenom,email,mot_de_passe,role) VALUES
 (N'Lefevre',N'Sophie',N'sophie.electricienne@example.fr',N'$2b$10$8hziSmZxIDIMx8/Ef0Z8d.G7i6rQE4Fj6sIfH1NIeskSSTrf/SeQy',N'PRESTATAIRE');
INSERT INTO dbo.prestataires(id_user,description,telephone,adresse,latitude,longitude,statut_validation) VALUES
...
INSERT INTO dbo.users(nom,prenom,email,mot_de_passe,role) VALUES
 (N'Garcia',N'Antoine',N'antoine.jardinier@example.fr',N'$2b$10$8hziSmZxIDIMx8/Ef0Z8d.G7i6rQE4Fj6sIfH1NIeskSSTrf/SeQy',N'PRESTATAIRE');
INSERT INTO dbo.prestataires(id_user,description,telephone,adresse,latitude,longitude,statut_validation) VALUES
